...
urlpatterns = [
    ...
    path('guardar-simulador-masivo-ml-junior/', views.guardar_simulador_masivo_ml_junior, name='guardar_simulador_masivo_ml_junior'),
    ...
    path('borrar-todos-simulador-ml-junior/', views.borrar_todos_simulador_ml_junior, name='borrar_todos_simulador_ml_junior'),
    ...
    path('descargar-plantilla-reporte-intercorp/', views.descargar_plantilla_reporte_intercorp, name='descargar_plantilla_reporte_intercorp'),
    path('guardar-reportes-masivos-intercorp/', views.guardar_reportes_masivos_intercorp, name='guardar_reportes_masivos_intercorp'),
    path('borrar-todos-los-reportes-intercorp/', views.borrar_todos_los_reportes_intercorp, name='borrar_todos_los_reportes_intercorp'),
    path('comisiones-intercorp/', views.comisiones_intercorp, name='comisiones_intercorp'),
    ...
    path('requerimientos/pagina-web/guardar/', views.guardar_evaluaciones_web, name='guardar_evaluaciones_web'),
    path('referencia-costos-web/guardar/', views.guardar_referencia_costos_web, name='guardar_referencia_costos_web'),
    path('api/buscar-costo-referencial/', views.api_buscar_costo_referencial, name='api_buscar_costo_referencial'),
]